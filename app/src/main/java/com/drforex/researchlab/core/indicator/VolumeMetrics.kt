 ...
 * traded volume.
 *
 * Missing volume is treated as unavailable rather than fabricated.
 *
...
object VolumeMetrics {
     ...
     *
     * Candles with unavailable volume are excluded from the average.
     */
    fun averageVolume(
     ...
     *
     * Returns null when the latest volume or comparison average
     * is unavailable.
     */
    fun relativeVolume(
        candles: List<MarketCandle>,
     ...
     * Zero corresponds to a neutral candle or unavailable volume.
     *
     * This is a price-direction proxy, not a claim about actual
     * buy/sell order flow.
     *
     * When volume is unavailable, no volume contribution is fabricated,
     ...
     *
     * Candles with unavailable volume contribute zero.
     */
     ...
     *
     * Candles with unavailable or invalid volume are excluded.
     *
     * Interpretation depends on whether the source volume represents
     * actual traded volume or tick volume.
     */
    fun vwap(
        candles: List<MarketCandle>,
        period: Int
     ...
     * comparison baseline.
     *
     * This preserves point-in-time behaviour and prevents the
     * current candle from entering its own historical baseline.
     */
